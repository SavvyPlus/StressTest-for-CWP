% The whole data is 55*300*6*2=198000 rows and 7 columns
% Columns: SimNo,WeekNo,WeeklyRevenue,4WeekRollingWeekNo,MonthlyRevenue,ScenarioNo,SpotNo

Output = zeros(198000,7);

% Simulation numbers
SimNo = zeros(198000,1);
temp1 = zeros(660,300);
for i = 1:300
    temp1(:,i) = i;
end
for i = 1:300
    SimNo(1+660*(i-1):660+660*(i-1)) = temp1(:,i);
end
% Week numbers
WeekNo = zeros(198000,1);
temp2 = zeros(55,1);
temp = zeros(660,1);
for i = 1:55
    temp2(i) = i;
...
for i = 1:300
    WeekNo(1+660*(i-1):660+660*(i-1)) = temp(:);
end
% Weekly Revenue
WeekRevenue = zeros(198000,1);
count = 0;
for i = 1:300
    for j = 1:6
        for k = 1:2
